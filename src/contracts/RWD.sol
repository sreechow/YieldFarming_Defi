...
contract RWD {
    ...
    uint256 private sgdtdenominaiton = 100000000000000000000000000; //equal to one sgd like wei in ether
    uint256 public totalSupply = 100000000000000000000000000; //so no need to provide many zeros
